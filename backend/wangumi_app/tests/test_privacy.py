...
class PrivacyViewTests(TestCase):
    ...
    def test_privacy_unauthorized(self):
        ...
        resp_put = self.client.put("/api/users/privacy", {"followers": "self"}, content_type="application/json")
